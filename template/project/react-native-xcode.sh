...
[ -z "$CLI_PATH" ] && export CLI_PATH="$REACT_NATIVE_DIR/node_modules/react-native/cli.js"

[ -z "$BUNDLE_COMMAND" ] && BUNDLE_COMMAND="bundle"

[ -z "$COMPOSE_SOURCEMAP_PATH" ] && COMPOSE_SOURCEMAP_PATH="$REACT_NATIVE_DIR/node_module/react-native/scripts/compose-source-maps.js"
